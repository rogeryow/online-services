...
<body>
	...
	<section class="showcase">
		<div class="container">
			<div class="showcase-inner">
				<h1>Save your time and let the service come to you</h1>

				<div class="finder">
					<input class="search" type="" name="" placeholder="What service do you need?">
					<button><i class="fa fa-search"></i></button>
				</div>
				
				<div class="category-link">
					<p class="label">View our categories below</p>
					<a class="" href="category.php">House Cleaning</a>|
					<a class="" href="category.php">Events</a>|
					<a class="" href="category.php">Body and Rejuvation</a>|
					<a class="" href="category.php">Rental</a>|
					<a class="" href="category.php">Delivery</a>
				</div>
			</div>
		</div>
	</section>
	...
	<div class="section-devider">
		<i class="fa fa"></i>
		<h2 class="sec-title">Popular Services In Digos</h2>
	</div>

	<section class="popular-services">
		<div>
			<img src="../assets/images/services/delivery.jpg">
			<p>Delivery</p>
		</div>
		<div>
			<img src="../assets/images/services/plumbing.jpg">
			<p>Plumbing Repair</p>
		</div>
		<div>
			<img src="../assets/images/services/cleaning.jpg">
			<p>Cleaning Services</p>
		</div>
		<div>
			<img src="../assets/images/services/massage.jpg">
			<p>Massage</p>
		</div>
		<div>
			<img src="../assets/images/services/electrician.jpg">
			<p>Electrical</p>
		</div>
	</section>
	...
	<section class="service-category">
		<h2>Looking for a service? look no further and see the listing below</h2>
		<div class="service-category-inner">
			<div class="service-category-item">
				...
				<ul>
					...
					<li><a href="#">Aircon Services</a></li>
				</ul>
<!-- 					<a class="btn-view" href="">
			...
			<div class="service-category-item">
				...
				<ul>
					...
					<li><a href="#">Birthday Decoration Services</a></li>
				</ul>
<!-- 					<a class="btn-view" href="">
						<span>View all</span>
					</a> -->
...
<!-- 					<a class="btn-view" href="">
			...
			<div class="service-category-item">
				...
				<div class="category-body">
				<ul>
					<li><a href="#">Tables & Affairs Rental</a></li>
